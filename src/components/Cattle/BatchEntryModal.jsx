        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-4 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 border-b border-slate-100 dark:border-slate-800 pb-3">
            ...
            <div className="flex items-center gap-2">
              <button
                type="button"
                onClick={() => setShowSeriesGenerator(!showSeriesGenerator)}
                className="px-3 py-1.5 rounded-xl bg-amber-50 dark:bg-amber-950/60 hover:bg-amber-100 dark:hover:bg-amber-900/60 text-amber-800 dark:text-amber-300 border border-amber-300 dark:border-amber-700 text-xs font-bold flex items-center gap-1.5 transition cursor-pointer"
                title="Generar serie consecutiva de aretes en 1 clic"
              >
                <Wand2 className="w-3.5 h-3.5 text-amber-600" />
                <span>⚡ Generador de Aretes Consecutivos</span>
              </button>
