...
/**
 * Busca un usuario en la Nube Global por su correo o usuario desde cualquier dispositivo
 */
...
export async function cloudDeleteUserData(userId, email) {
  try {
    ...
    // Limpiar claves locales de referencia
